...
/**
   @fn double gen_p_sq( const size_t i , const size_t DIMS )
...
/**
   @fn double gen_p_sq_feyn( const size_t i , int *flag )
...
/**
   @fn void gen_get_p( double p[ ND ] , const size_t i , const size_t DIMS )
