		    ...
		    const char *outfile )
{
  ...
  // correlators
  struct mcorr **Buds_corr = NULL , **Buds_corrWW = NULL ;
  ...
  for( t = 0 ; t < LT ; t++ ) {
    ...
    // momentum projection 
    baryon_momentum_project( Buds_corr , in , out , forward , backward ,
  ...
  write_baryon( Buds_corr , list , NMOM , GLU_FALSE , outfile , "uds" ) ;
